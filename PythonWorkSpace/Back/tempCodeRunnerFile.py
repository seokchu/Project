...
class Process_of_DB: #firebase에 연결 및 데이터를 가져오는 클래스
    ...
    def get_document(self,path: str) -> Any: #반환값의 type이 어떤 것이든 상관이 없다는 것
...
firebase_client = Process_of_DB("/Users/minji/Desktop/한밭대/[강의]24_2학년_2학기/오픈소스/RevKeyRec/osp-revkeyrec-firebase-adminsdk-rvlp5-034c3d1c56.json","https://osp-revkeyrec-default-rtdb.firebaseio.com")
